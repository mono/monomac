...
#pragma warning disable 1573
        ...
        public static void Color3(MonoMac.AppKit.NSColor color)
        {
            GL.Color3(color.RedComponent, color.GreenComponent, color.BlueComponent);
        }

        public static void Color4(MonoMac.AppKit.NSColor color)
        {
        ...
        {
            int length;
            GetProgram(program, MonoMac.OpenGL.ProgramParameter.ActiveAttributeMaxLength, out length);
        ...
        {
            int length;
            GetProgram(program, MonoMac.OpenGL.ProgramParameter.ActiveUniformMaxLength, out length);
        ...
        //{
        //    int length;
        //    GetProgram(program, MonoMac.OpenGL.ProgramParameter.ActiveUniformBlockMaxNameLength, out length);
        //    StringBuilder sb = new StringBuilder(length == 0 ? 1 : length * 2);
        ...
        public static void GetProgramInfoLog(Int32 program, out string info)
        {
            ...
            {
                int length;
                GL.GetProgram(program, MonoMac.OpenGL.ProgramParameter.InfoLogLength, out length); if (length == 0)
                {
                    info = String.Empty;
                    return;
                }
        ...
        //public static void DisableClientState(MonoMac.OpenGL.EnableCap array)
        //{
        ...
        //public static void EnableClientState(MonoMac.OpenGL.EnableCap array)
        //{
