...
namespace MonoMac.CoreAnimation {
	[Register("CAAction")]
	[Model]
	public partial class CAAction : NSObject {

		static IntPtr class_ptr = Class.GetHandle ("CAAction");

		[Export ("init")]
		public CAAction () : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		public CAAction (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			if (IsDirectBinding) {
		...
		public CAAction (NSObjectFlag t) : base (t) {}

		public CAAction (IntPtr handle) : base (handle) {}
